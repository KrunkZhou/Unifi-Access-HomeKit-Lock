...
//顺序对应页码 从第2页也就是编号1开始
//不要忘记改变array大小
//{ "Num", "HB Port", "Title", "up_name", "middle_name", "down_name" }
const String menu_config[7][6] = { { "0", "0", "Access System" }, 
...
const int enable_welcome_notice = 0; //开启欢迎界面
...
void open_door(){
  ...
  draw_title("Processing",TFT_CYAN);
  result=http_action(44100, "kiot-button/1");
  tft.setFreeFont(&FreeSansBold12pt7b);
    
  if (result==200){ //成功执行
    tft.setCursor((320 - tft.textWidth("Access Granted"))/2, 115);
    ...
    tft.setCursor((320 - tft.textWidth("Unlock Failed"))/2, 115);
    tft.print("Unlock Failed");
